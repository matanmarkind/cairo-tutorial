...
# Set an identifier to represent what we're voting for. This will appear
# in the user's signature to distinguish between different polls.
POLL_ID = 10018
...
with open('voting_input.json', 'w') as f:
    json.dump(inpute_data, f, indent=4)
    f.write(os.linesep)